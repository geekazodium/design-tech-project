...
const terrainLayered = new LayeredPerlinNoise({scale:7.5,x:0,y:0,weight:10,bias:0.5},{scale:10,x:0,y:0,weight:100,bias:0.5},{scale:1,x:0,y:0,weight:10,bias:0},{scale:0.5,x:0,y:0,weight:2,bias:0});
